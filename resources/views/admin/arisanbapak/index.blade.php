        ...
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col-md-6 col-sm-12 text-center text-md-left">
              <h2 class="mb-0">Arisan Bapak-Bapak</h2>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action='/admin/arisanBapak/tambah' method='post' >
          {{ csrf_field() }}
          <div class="row">
            <div class="col-md-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php
          ...
          foreach($data_ariba -> where('id', $idAri) as $data) {
        ...
        ?>
        <form action='/admin/arisanBapak/{{$idAri}}/ubah' method='post' >
          {{ csrf_field() }}
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <select class="form-control form-control-alternative" name='tempat' required>
                  <option disabled selected>Nama</option>
                  @foreach($data_kel as $data)
                    <option value="{{$data -> id}}" @if($data -> id == $id) selected @endif >{{$data -> nama}}</option>
                  @endforeach
                </select>
              </div>
            </div>
...
<script>
  $('.hapus').click(function() {
    ...
    .then((willDelete) => {
      if (willDelete) {
        window.location = "/admin/arisanBapak/"+arid+"/hapus";
      } else {
